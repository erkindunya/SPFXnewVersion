...
<div>
    ...
    <div class="form-group">
        ...
        <p v-if="firstChoiceUsername && !containsMiddleInital" class="alert alert-warning">"{{firstChoiceUsername}}" is not available. You could add a middle initial or {{formData.username}} will be used.</p>
    </div>
    <div class="form-group">
